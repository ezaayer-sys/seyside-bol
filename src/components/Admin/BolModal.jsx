    ...
    try {
      ...
      if (resendKey) {
        ...
        const emailHtml = '<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;">'
          ...
          + '<h2 style="margin:0;font-size:18px;">BOL Printed — ' + load.bol_number + '</h2></div>'
          ...
          + '<a href="https://seyside-bol1.speysideshipments.workers.dev/admin/bol-log" style="background:#2d5016;color:#fff;padding:10px 20px;border-radius:6px;text-decoration:none;font-weight:bold;">View BOL Log</a>'
          + '</div></div></div>';
